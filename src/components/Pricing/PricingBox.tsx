const PricingBox = (props: {
  ...
  return (
    <div className="w-full">
      <div className="relative z-10 rounded-sm bg-white px-8 py-10 shadow-three hover:shadow-one bg-gray-dark shadow-two hover:shadow-gray-dark">
        ...
        <div className="mb-8 border-b border-body-color border-opacity-10 pb-8 border-white border-opacity-10">
