...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-gray-dark md:pt-20 lg:pt-24 pt-4">
        <div className="container">
          <div className="-mx-4 flex flex-wrap  justify-between">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base leading-relaxed  text-white font-semibold ">
                  VIKASRATNA VILASRAO DESHMUKH MANJARA S.S.S.K.LTD, VILAS
                  NAGAR,CHINCHOLIRAO WADI , BARSHI ROAD, LATUR - 413531
                </p>
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12 ">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold  uppercase text-white">
                  Contact
                </h2>
                <ul>
                  <li>
          ...
          <div className="py-8">
            <p className="text-center text-base text-white">
              Copyright {new Date().getFullYear()} Gramin T10. All rights
              reserved.
            </p>
          </div>
        </div>
        ...
        <Image
          src="/assets/trofee.png"
          width={0}
          height={0}
          sizes="100vw"
          alt="Audience"
          className="absolute left-[50%] translate-x-[-50%] bottom-36 z-[-1]  w-[250px] h-[30%]  md:h-[60%] object-contain   grayscale-1  drop-shadow-[0_10px_25px_rgba(255,255,255,0.7)] "
        />
