...
const AppTextField = ({ type = 'text', name, required = true }) => {
  const { register } = useForm()
  return (
    <>
      <div className="relative w-full min-w-[200px] h-10">
        <input
          className="peer w-full h-full bg-transparent text-blue-gray-700 font-sans font-normal outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 border focus:border-1 t focus:border-t-transparent text-sm px-3 py-2.5  border-blue-gray-200 focus:border-primary "
          placeholder=" "
        />
