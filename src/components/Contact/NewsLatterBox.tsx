...
import AppTextField from '@/components/ui/AppFormComponents/AppTextField'

const NewsLatterBox = () => {
  const { theme } = useTheme()

  return (
    <div className="relative z-10 rounded-sm p-8 shadow-three bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      <div>
        <div className="w-72 mt-5">
          <AppTextField name={'name'} label="Enter your name"></AppTextField>
        </div>
        ...
        {/* <input
          ...
          className="border-stroke mb-4 w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none focus:border-primary border-transparent bg-[#2C303B] text-body-color-dark shadow-two focus:border-primary focus:shadow-none"
        />
        <input
          type="submit"
          value="Subscribe"
