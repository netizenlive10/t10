        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            ...
            <div className="w-full px-4 lg:w-4/12">
              <div className=" mb-10 mt-12 rounded-sm p-6 shadow-none lg:mt-0">
                <div className="flex items-center justify-between">
                  <input
                    type="text"
                    placeholder="Search here..."
                    className="border-stroke  shadow-two mr-4 w-full rounded-sm border  px-6 py-3 text-base text-body-color outline-none transition-all duration-300  border-transparent bg-[#2C303B] focus:border-primary focus:shadow-none"
                  />
                  <button
              ...
              <div className=" bg-gray-dark mb-10 rounded-sm shadow-none">
                ...
                <ul className="p-8">
                  <li className="mb-6 border-b   pb-6 border-white border-opacity-10">
                    <RelatedPost
              ...
              <div className=" mb-10 rounded-sm shadow-none">
                <h3 className="border-b  px-8 py-4 text-lg font-semibold  border-white border-opacity-10 text-white">
                  Popular Tags
                </h3>
